...
static inline bool is_valid_state_transition(app_state_t from, app_state_t to)
{
    ...
    const size_t num_transitions = sizeof(valid_transitions) / sizeof(valid_transitions[0]);
...
static inline esp_err_t app_state_set(app_context_t *ctx, app_state_t new_state)
{
